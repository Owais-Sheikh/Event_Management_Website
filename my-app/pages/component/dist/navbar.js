...
var Navbar = function () {
    ...
    return (React.createElement("nav", { className: "flex flex-wrap items-center justify-between bg-gradient-to-r from-green-400 to-blue-500 px-4 py-3" },
        React.createElement("div", { className: "flex items-center" },
            React.createElement(link_1["default"], { href: "/", className: "text-xl font-bold text-white mr-6" }, "Event Planner"),
            React.createElement("form", { onSubmit: handleSearchSubmit },
                React.createElement("div", { className: "relative" },
                    React.createElement("input", { type: "text", placeholder: "Search", value: searchQuery, onChange: function (event) { return setSearchQuery(event.target.value); }, className: "px-3 py-2 rounded-lg bg-white text-gray-800 placeholder-gray-400 focus:outline-none focus:shadow-outline" }),
        ...
        React.createElement("button", { className: "block sm:hidden border border-white rounded px-2 py-1", onClick: handleMenuClick }, isMenuOpen ? "Close" : "Menu"),
