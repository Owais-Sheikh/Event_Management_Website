...
const slug = (props:any) => {
  ...
  return (
    <section className={`text-gray-600 body-font ${updateEvent? 'blur-md' : 'blur-0'}`}>
  <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
    ...
    <div className="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
      ...
      <div className='flex'>
      <h1 className='font-semibold text-gray-900 mr-2'>StartTime : </h1><p className="text-sm mb-2 leading-relaxed">{props.event.startTime}</p></div>      <div className='flex'>
      <h1 className='font-semibold text-gray-900 mr-2'>EndTime : </h1><p className="text-sm mb-6 leading-relaxed">{props.event.endTime}</p></div>
