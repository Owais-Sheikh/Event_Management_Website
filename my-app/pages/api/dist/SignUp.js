...
var handler = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, name, email, ciphertext, u;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                if (!(req.method == 'POST')) return [3 /*break*/, 2];
                _a = req.body, name = _a.name, email = _a.email;
                ciphertext = CryptoJS.AES.encrypt(req.body.password, 'secret key 123').toString();
                u = new user_1["default"]({ name: name, email: email, password: ciphertext });
...
exports["default"] = mongoose_1["default"](handler);
