    ...
    return (react_1["default"].createElement("div", { className: "px-16 container bg-fixed bg-cover bg-center bg-[url('../public/aditya-chinchure-ZhQCZjr9fHo-unsplash.jpg')] h-64 md:h-96" },
        ...
        react_1["default"].createElement("div", { className: 'mt-20 flex justify-center items-center flex-wrap' },
            react_1["default"].createElement("div", { className: 'flex items-start flex-col' },
                ...
                react_1["default"].createElement("input", { className: event_module_css_1["default"].input + " mr-10 mb-14", onChange: setValue, value: name, name: "name", type: "text" })),
            react_1["default"].createElement("div", { className: 'flex items-start flex-col' },
                react_1["default"].createElement("label", { className: 'mb-2 text-green-800 font-semibold', htmlFor: "" }, "Email"),
                react_1["default"].createElement("input", { className: event_module_css_1["default"].input + " mr-10 mb-14", onChange: setValue, value: email, name: "email", type: "email" })),
            react_1["default"].createElement("div", { className: 'flex items-start flex-col' },
                react_1["default"].createElement("label", { className: 'mb-2 text-green-800 font-semibold', htmlFor: "" }, "Phone"),
                react_1["default"].createElement("input", { className: event_module_css_1["default"].input + " mr-10 mb-14", onChange: setValue, value: phone, name: "phone", type: "tel" })),
            react_1["default"].createElement("div", { className: 'flex items-start flex-col' },
                react_1["default"].createElement("label", { className: 'mb-2 text-green-800 font-semibold', htmlFor: "" }, "Event Type"),
                react_1["default"].createElement("input", { className: event_module_css_1["default"].input + " mr-10 mb-14", onChange: setValue, value: eventType, name: "EventType", type: "text" })),
            react_1["default"].createElement("div", { className: 'flex items-start flex-col' },
                react_1["default"].createElement("label", { className: 'mb-2 text-green-800 font-semibold', htmlFor: "" }, "Event Description"),
                react_1["default"].createElement("textarea", { className: event_module_css_1["default"].input + " mr-10 mb-14", onChange: setValue, value: eventDesc, name: "Desc", cols: 30, rows: 2 })),
            react_1["default"].createElement("div", { className: 'flex items-start flex-col' },
                react_1["default"].createElement("label", { className: 'mb-2 text-green-800 font-semibold', htmlFor: "" }, "Event Date"),
                react_1["default"].createElement("input", { className: event_module_css_1["default"].input + " mr-10 mb-14", onChange: setValue, value: eventDate, name: "date", type: "date" })),
            react_1["default"].createElement("div", { className: 'flex items-start flex-col' },
                react_1["default"].createElement("label", { className: 'mb-2 text-green-800 font-semibold', htmlFor: "" }, "Start Time"),
                react_1["default"].createElement("input", { className: event_module_css_1["default"].input + " mr-10 mb-14", onChange: setValue, value: startTime, name: "STime", type: "time" })),
            react_1["default"].createElement("div", { className: 'flex items-start flex-col' },
                react_1["default"].createElement("label", { className: 'mb-2 text-green-800 font-semibold', htmlFor: "" }, "End Time"),
                react_1["default"].createElement("input", { className: event_module_css_1["default"].input + " mr-10 mb-14", onChange: setValue, value: endTime, name: "ETime", type: "time" })),
            react_1["default"].createElement("div", { className: 'flex items-start flex-col' },
                react_1["default"].createElement("label", { className: 'mb-2 text-green-800 font-semibold', htmlFor: "" }, "Total Guest"),
                react_1["default"].createElement("input", { className: event_module_css_1["default"].input + " mr-10 mb-14", onChange: setValue, value: totalGuest, name: "TGuest", type: "text" })),
